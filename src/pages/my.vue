...
<template>
    ...
    <v-list>
        ...
        <Profile name="OPSTID" opstidId="d1fd17c6b612" avatarPath="/icon.svg" to="/p" lines="two"></Profile>
        <div class="text-right">
            <v-btn size="small" variant="text" color="indigo" append-icon="mdi-arrow-right" to="/my/change-main-profile" hasEditButton hasShareButton>メインプロフィールを変更</v-btn>
        </div>
    </v-list>
