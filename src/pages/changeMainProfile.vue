...
<template>
    ...
    <v-radio-group v-model="selectedProfile" class="mt-2" color="blue">
        ...
        <v-radio value="ace97b838b9d">
            <template v-slot:label>
                <Profile name="ace97b838b9d" opstidId="ace97b838b9d" :avatarPath="generateProfileAvatarPath('ace97b838b9d')">
                </Profile>
            </template>
        </v-radio>
        <v-radio value="ca972cbe7116">
            <template v-slot:label>
                <Profile name="ca972cbe7116" opstidId="ca972cbe7116" :avatarPath="generateProfileAvatarPath('ca972cbe7116')">
                </Profile>
            </template>
        </v-radio>
        <v-radio value="8554bbc654b8">
            <template v-slot:label>
                <Profile name="8554bbc654b8" opstidId="8554bbc654b8" :avatarPath="generateProfileAvatarPath('8554bbc654b8')">
                </Profile>
            </template>
        </v-radio>
    </v-radio-group>
