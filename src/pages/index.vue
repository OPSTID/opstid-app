...
<template>
    ...
    <!-- search and scan -->
    <v-text-field variant="solo" density="compact" prepend-inner-icon="mdi-magnify" placeholder="検索..." readonly @click="$router.push('/search')">
        <template v-slot:append>
    ...
    <v-list lines="two">
        ...
        <Profile :avatarPath="generateProfileAvatarPath()" name="546f17300a86" opstidId="546f17300a86" note="昨日フォローしました"
            @click=""></Profile>
        <Profile :avatarPath="generateProfileAvatarPath()" name="3942157ab317" opstidId="3942157ab317" note="4/24にフォローしました"
            @click=""></Profile>
    </v-list>
</template>